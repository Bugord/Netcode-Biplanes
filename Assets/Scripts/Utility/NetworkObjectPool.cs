...
public class NetworkObjectPool : NetworkBehaviour
{
    ...
    public static NetworkObjectPool Singleton => instance;
...
internal struct PoolConfigObject
{
    ...
    [FormerlySerializedAs("PrewarmCount")]
...
internal class PooledPrefabInstanceHandler : INetworkPrefabInstanceHandler
{
    ...
    private readonly NetworkObjectPool mPool;
    ...
    NetworkObject INetworkPrefabInstanceHandler.Instantiate(ulong ownerClientId, Vector3 position,
        Quaternion rotation)
    {
        var netObject = mPool.GetNetworkObject(mPrefab, position, rotation);
        return netObject;
    }

    void INetworkPrefabInstanceHandler.Destroy(NetworkObject networkObject)
    {
        mPool.ReturnNetworkObject(networkObject, mPrefab);
    }
}